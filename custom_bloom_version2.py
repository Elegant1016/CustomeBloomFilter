...
class CustomBloomFilter:
    ...
    def lookup(self, string):
        ...
        prob = (1.0 - ((1.0 - 1.0/self.size)**(self.hash_count*self.bit_occupied))) ** self.hash_count
...
if __name__ == "__main__":
    ...
    list_of_objects = ["Hello", "b732b2689c7e584afa75383840655a56", "9aab2bc5fba3ed3ba42802df1b332bad", "581ac41b3844d3076973ededdcdac009", "581ac41b3844d3076973ededdcdac",
                       "ea18f2b812afb9192cb8a4fc9be74bc0", "ea18f2b812afb9192cb8a4fc9be74bbb"]

    # print "Total object read:", cbf.bit_occupied

    for item in list_of_objects:
        start = datetime.datetime.now()
        if item in cbf:
            finish = datetime.datetime.now()
            print "Found with false positive probability as ", cbf.prob, "time taken in microseconds:", (finish - start).microseconds
        else:
            print "Not Found"
